...
// chrome.bookmarks.search(_("bookmarks.group"), function(nodes) {
//     qwantGroup = nodes[0];
// });
...
function qwantGroupExists() {
    return new Promise(function(resolve, reject) {
        chrome.bookmarks.search(_("bookmarks_group"), function(nodes) {
...
function setFirefoxBookmarks(newBookmarks) {
    return new Promise(function (resolve, reject) {
        ...
        chrome.bookmarks.create(newBookmarks, function(result) {
            resolve(true);
        });
...
function getFirefoxBookmarks() {
    return new Promise(function (resolve, reject) {
        ...
        chrome.bookmarks.get(qwantGroup.id, function(results) {
            resolve(results);
        });
