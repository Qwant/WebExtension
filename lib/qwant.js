...
//     if(changeInfo.status == 'loading' && changeInfo.url && changeInfo.url.substring(0, 6).toLowerCase() != 'chrome') {
//         websitesQueue.push({
//             tabId: tabId,
//             url: changeInfo.url
//         });
//     } else if (changeInfo.status == 'complete') {
//         let found = websitesQueue.find(object => object.tabId == tabId && object.url == tab.url);
//         if(found) {
//             websitesQueue.splice(websitesQueue.indexOf(found), 1);
//             localstorage.load('indexedWebsites', indexedWebsites => {
//                 indexedWebsites = indexedWebsites ? JSON.parse(indexedWebsites) : [];
//                 indexedWebsites.push({
//                     url: tab.url,
//                     title: tab.title
//                 });
//                 localstorage.save('indexedWebsites', JSON.stringify(indexedWebsites));
//             });
//         }
//     }
// });
